...
export declare class ApolloClientManager {
    ...
    createCheckout: (email: string, lines: Array<{
        variantId: string;
        quantity: number;
    }>, channel: string, shippingAddress?: ICheckoutAddress | undefined, billingAddress?: ICheckoutAddress | undefined, note?: string | undefined) => Promise<{
        data: ICheckoutModel;
        error?: undefined;
    } | {
        error: any;
    ...
    updateNote: (token: string, note: string) => Promise<{
        error?: undefined;
    } | {
        error: any;
    }>;
