...
import { CompleteCheckoutJobInput, CreatePaymentJobInput, RemovePromoCodeJobInput, AddPromoCodeJobInput, SetShippingMethodJobInput, ProvideCheckoutJobInput, CreateCheckoutJobInput, SetShippingAddressJobInput, SetBillingAddressJobInput, SetBillingAddressWithEmailJobInput, updateNoteInput } from "./types";
...
declare class CheckoutJobs extends JobsHandler<{}> {
    ...
    createCheckout: ({ email, lines, channel, shippingAddress, selectedShippingAddressId, billingAddress, selectedBillingAddressId, note }: CreateCheckoutJobInput) => PromiseCheckoutJobRunResponse;
    ...
    updateNote: ({ token, note }: updateNoteInput) => Promise<{
        dataError: {
            error: any;
